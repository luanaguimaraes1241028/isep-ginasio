                            ...
                            <!-- Linhas e colunas com campos organizados -->
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" id="texto_endereco"
                                                name="morada_cliente" value="Rua das Flores, 12, 1º Esq">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" id="texto_cp" name="cp_cliente" value="4000-001"
                                            required>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="email" class="form-control" id="texto_email" name="email_cliente" value="ana.beatriz@email.com" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="texto_dnasc" name="dnasc_cliente" value="16-04-2003"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="texto_SSaude" name="campo_opcao" value="ADSE"
                                            list="sistemasaude">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="profissao" name="profissao_cliente" value="Nutricionista" required>
                                    </div>
                                </div>
                            ...
                            <!-- Botões -->
